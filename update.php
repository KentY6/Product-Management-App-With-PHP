...
<body style="text-align: center;">
    ...
    ">
        <article style="width: 20%; ">
            ...
            <form action="update.php?id=<?= $_GET['id'] ?>" method="post" style="
                width: 100%; 
                display: flex;
                flex-flow: column;
                align-items: center;
